defmodule GameOfLife do
  ...
  Each cell is tracked a list that represents its coordinate
  ...
  The state we pass to the next iteration is simply a list of
  active cells.
  """

  @doc ~S"""
  Transform current board state to the next iteration.
  Returns a list of active cells
  """
  ...
  @doc ~S"""
  Calculate the number of active neighbours for a cell
  """
